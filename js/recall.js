...
// 미리 5개 묶음으로 큐레이션해둔다(2026-08-22, jongik.rha 제안). 목록은
// 그때그때 감이 아니라 실제 운영 데이터(prod AppSync, 노래가 첨부된 활성
// 기억 203개 기준)의 해시태그 빈도를 직접 집계해서 뽑았다 — 예를 들어
// "강원도"는 예시로 거론됐지만 실제로 쓰인 적이 없어 빼고, 대신 실제
// 상위 태그인 "제주도"/"해운대"/"강릉"/"광안리"를 넣었다. 이 정도 마진
// (그룹당 25~53곡)이면 곡이 좀 늘어나도 10곡 밑으로 안 떨어질 여유가
// 있다. 새 해시태그가 계속 늘어나는 자유입력 특성상 이 목록은 주기적으로
// 다시 훑어봐야 한다 — 완전 자동화된 클러스터링은 아니다.
//
...
const RADIO_THEME_GROUPS = [
  { label: "첫사랑·설렘", tags: ["#첫사랑", "#짝사랑", "#썸", "#고백", "#데이트", "#커플", "#사랑", "#소개팅", "#연애", "#이별"] },
  { label: "추억·그리움", tags: ["#추억", "#그리움", "#옛기억", "#과거", "#기억", "#회상", "#후회", "#아쉬움"] },

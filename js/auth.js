...
const Auth = {
  ...
  mapError(e) {
    const known = {
      ...
      InvalidPasswordException: "비밀번호는 최소 8자 이상이어야 합니다.",
...
function renderAuthPanel() {
  ...
  if (authMode === "signup") {
    panel.innerHTML = `
      ...
      <input type="password" id="auth-password" class="input-field" placeholder="최소 8자" maxlength="128" value="${escapeHtml(authPasswordValue)}" />
      ${errorHtml}
